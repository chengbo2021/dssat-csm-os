...
!-----------------------------------------------------------------------
      ...
      REAL BC_SORP_NH4(NL)                 !Biochar NH4 sorption (kg N/ha)
...
!     Biochar NH4 sorption (1-day lag; uses previous day's dSorbNH4)
      DO L = 1, NLAYR
        IF (BC_SORP_NH4(L) .GT. 0.0) THEN
          DLTSNH4(L) = DLTSNH4(L) -
     &        MIN(BC_SORP_NH4(L), AMAX1(0.0, SNH4(L)+DLTSNH4(L)))
        END IF
      END DO
